...
```
    ...
    ## 106 observations missing `drug` have been removed. To include these observations, use `forcats::fct_explicit_na()` on `drug` column before passing to `tbl_summary()`.

``` r
table1
```

<div id="codxlxisyl" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#codxlxisyl .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#codxlxisyl .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#codxlxisyl .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#codxlxisyl .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#codxlxisyl .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#codxlxisyl .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#codxlxisyl .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#codxlxisyl .gt_from_md > :first-child {
  margin-top: 0;
}

#codxlxisyl .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#codxlxisyl .gt_row_group_first td {
  border-top-width: 2px;
}

#codxlxisyl .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#codxlxisyl .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#codxlxisyl .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#codxlxisyl .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#codxlxisyl .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#codxlxisyl .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#codxlxisyl .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#codxlxisyl .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#codxlxisyl .gt_font_normal {
  font-weight: normal;
}

#codxlxisyl .gt_font_bold {
  font-weight: bold;
}

#codxlxisyl .gt_font_italic {
  font-style: italic;
}
...
#codxlxisyl .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#codxlxisyl .gt_indent_1 {
  text-indent: 5px;
}

#codxlxisyl .gt_indent_2 {
  text-indent: 10px;
}

#codxlxisyl .gt_indent_3 {
  text-indent: 15px;
}

#codxlxisyl .gt_indent_4 {
  text-indent: 20px;
}

#codxlxisyl .gt_indent_5 {
  text-indent: 25px;
}
</style>
